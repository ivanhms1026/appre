...
import 'package:appre/administrator_module/userInformation.dart';
import 'package:appre/colors.dart';
import 'package:appre/menu_app/login/session.dart';

class AdministratorModule extends StatefulWidget {
  final UserCredentials credentials;

  const AdministratorModule({Key? key, required this.credentials}) : super(key: key);

  @override
  State<AdministratorModule> createState() => _AdministratorModuleState();
}

class _AdministratorModuleState extends State<AdministratorModule> {
  List<Map<String, dynamic>> userList = [];

  Future<void> fetchUserData() async {
    final response = await http.get(Uri.parse("https://appreopc.000webhostapp.com/getDataAdmin.php"));
